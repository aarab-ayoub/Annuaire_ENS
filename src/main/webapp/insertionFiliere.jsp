...
<%@ page import="com.company.dao.FiliereDAO" %><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Insertion d'une nouvelle filière</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
        <script>
        function validateForm() {
            var nom = document.getElementById("nomFiliere").value;
            var departement = document.getElementById("idDepartement").value;
...
<div class="container mx-auto py-8 px-4 md:px-0">
    <h1 class="text-3xl text-center mb-8">Insertion d'une nouvelle filière</h1>
    <form action="InsertionFiliereServlet" method="post" class="mx-auto max-w-md" onsubmit="return validateForm()">
        <div class="mb-4">
            <label for="nomFiliere" class="block text-gray-700 font-bold mb-2">Nom de la filière</label>
            <input type="text" id="nomFiliere" name="nomFiliere" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
        <div class="mb-4">
            <label for="idDepartement" class="block text-gray-700 font-bold mb-2">Département</label>
            <select id="idDepartement" name="idDepartement" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
